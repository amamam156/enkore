...
/**
 * Object mapper: Convert Java objects to json based on jackson, or convert json to Java objects The process of parsing
...
public class JacksonObjectMapper extends ObjectMapper
{
    ...
    public JacksonObjectMapper()
    {
        ...
        SimpleModule simpleModule = new SimpleModule().addDeserializer(LocalDateTime.class,
                ...
                .addSerializer(Long.class, ToStringSerializer.instance).addSerializer(LocalDateTime.class,
